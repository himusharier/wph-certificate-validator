        ...
        <div class="aph-buradio-admin-modal-form">
            <div class="aph-buradio-admin-details">
                <form action="" method="post">
                    ...
                    <input type="text" name="programe_name" id="programe_name" value="<?php echo $retrieved_data->programe_name; ?>" required>
                    <label for="programe_host">Host Name</label>
                    <input type="text" name="programe_host" id="programe_host" value="<?php echo $retrieved_data->programe_host; ?>" required>
                    <label for="schedule_date">Schedule Date</label>
                    <input type="text" name="schedule_date" id="schedule_date" value="<?php echo $retrieved_data->schedule_date; ?>" required>
                    <label for="file_url">File Link <i>(with .mp3 at the end)</i></label>
                    <textarea name="file_url" id="file_url" required><?php echo $retrieved_data->file_url; ?></textarea>
                    <br/>
